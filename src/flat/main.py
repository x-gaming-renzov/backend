...
from .execute.main import execute  # Assuming execute/main.py has this function
...
def flatten_json(data_json):
    """
    Plan to create action json
    then execute action on data json
    """

    action_json = process_json(data_json)
    flat_json = execute(data_json,action_json)
    return flat_json
